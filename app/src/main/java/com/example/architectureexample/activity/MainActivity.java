package com.example.architectureexample.activity;
...
import com.example.architectureexample.NoteAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == ADD_NOTE_REQUEST && resultCode==RESULT_OK){
            ...
            if(id==-1){
                Toast.makeText(this,"Not güncellenemedi",
            ...
            Toast.makeText(this,"Not güncellendi",
                    Toast.LENGTH_SHORT).show();
        }
           else {
            Toast.makeText(this,
                    "Kaydedilmedi",Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.deleteAllNotes:
                ...
                Toast.makeText(this,"Tüm Notlar Silindi",
                        Toast.LENGTH_SHORT).show();
                return true;
